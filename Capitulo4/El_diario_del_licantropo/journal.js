/*
Define la variable JOURNAL, que es un array de objetos. 
Cada objeto representa un día en el diario y tiene dos propiedades:
    - events: Un array de strings con los eventos que ocurrieron ese día (ej. "carrot", "work", "brushed teeth").
    - squirrel: Un booleano que indica si el hombre se convirtió en ardilla ese día.

Al final del archivo, hay un código para asegurar que JOURNAL se pueda exportar y utilizar en otros contextos como Node.js o un navegador web.
*/
var JOURNAL = [
